...
public class Course_View extends Activity  implements OnClickListener{
   ...
   private void initView(){
	   ...
	   if(mData.size()>0){
		   ...
		   for (int i=0;i<mData.size();i++) {
			   View item =LayoutInflater.from(Course_View.this).inflate(R.layout.item_course_detail_view, null);
	...
	public void onClick(View v) {
		...
		switch(v.getId()){
		    ...
		    case R.id.edit_course_info:
		    	...
		    	intent.setClass(context, Course_edit.class);
