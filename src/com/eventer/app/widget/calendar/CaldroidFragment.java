...
public class CaldroidFragment extends DialogFragment {
	...
	public void SetScheduleDates(){
    	...
    	Cursor c=dbHelper.findList(true, "dbSchedule", new String[]{"startTime","endTime","frequency"}, null, null, null, null, null, null);
    	 while (c.moveToNext()) {   
	...
	public void moveToToday() {
		...
		DateTime today=new DateTime(today_str);
		moveToDateTime(today);
	}
